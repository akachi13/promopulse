      ...
      <AdminGuard>
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020617] px-6 text-white">
          ...
          <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.05] p-8 text-center shadow-2xl backdrop-blur-2xl">
            ...
            <p className="mt-5 text-slate-300">Chargement du magasin...</p>
          </div>
        </main>
      </AdminGuard>
    );
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.05] p-7 shadow-2xl backdrop-blur-2xl md:p-9">
              ...
              <div className="relative">
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-400">
                  Modifiez les informations du magasin, ses sources web,
                  Facebook et TikTok, sa localisation et son statut de
                  visibilité dans PromoPulse.
                </p>
              ...
              <div className="relative flex h-full flex-col justify-between gap-8">
                <div>
                  ...
                  <p className="mt-5 leading-7 text-emerald-100">
                    {form.description ||
                      "La description du magasin apparaîtra ici pendant la modification."}
                  </p>
                ...
                <div className="rounded-3xl border border-emerald-300/20 bg-slate-950/40 p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-emerald-100">
                    Vérifiez les sources avant un scan Gemini : un lien faux ou
                    vide peut empêcher la détection des promotions.
                  </p>
                </div>
              </div>
            </aside>
          ...
          >
            <section className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex gap-3">
                      <input
                        ...
                        required
                        className="w-full rounded-2xl border border-white/10 bg-slate-950/70 px-4 py-3.5 text-white outline-none transition hover:border-white/20 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-400/10"
                      />
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl">
                ...
                <h2 className="mt-3 text-2xl font-black">Pays et ville</h2>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-400">
                  Ces liens sont utilisés pour l’import intelligent Gemini et
                  l’identification des promotions du magasin.
                </p>
